...
public class EventHashMapConverter implements AttributeConverter<Map<String, Object>, String> {
    ...
    public String convertToDatabaseColumn(Map<String, Object> payloadInfo) {
        ...
        try {
            ...
            logger.error("EVENT-SOURCE: json event-source db writting error",e);
        }
    ...
    public Map<String, Object> convertToEntityAttribute(String payloadJSON) {
        ...
        try {
            ...
            logger.error("EVENT-SOURCE: json event-source db reading error",e);
        }
