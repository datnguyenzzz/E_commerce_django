...
public interface ItemStatusInterface {
    ...
    public final static String DISTANCE_TO_CENTRE = "distance_to_centre"; //long
    public final static String VECTOR_PROPERTIES = "vector_properties"; //list<int>

    SimpleStatement createRowIfNotExists();
    SimpleStatement addNewItemStatus(String itemId, String clientId, UUID boundedRingId, int centreId, long dist, List<Integer> properties);
