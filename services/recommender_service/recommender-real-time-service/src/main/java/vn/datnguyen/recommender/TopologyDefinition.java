...
public class TopologyDefinition {
    ...
    private static final String ITEM_COUNT_BOLT_THREADS = customProperties.getProp("ITEM_COUNT_BOLT_THREADS");
    ...
    private final static String ITEM_COUNT_BOLT = customProperties.getProp("ITEM_COUNT_BOLT");
    ...
    private static void createTopology() throws Exception {
        ...
        topologyBuilder.setBolt(ITEM_COUNT_BOLT, boltFactory.createItemCountBolt(), Integer.parseInt(ITEM_COUNT_BOLT_THREADS))
