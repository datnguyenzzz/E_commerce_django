...
public interface BoundedRingInterface {
    ...
    public final static String LOWER_BOUND_RANGE = "lower_bound_range"; //long
    public final static String UPPER_BOUND_RANGE = "upper_bound_range"; // long
    public final static String CAPACITY = "capacity"; // int

    SimpleStatement createRowIfNotExists();
    SimpleStatement addNewBoundedRing(UUID ringId, int centreId, long lbRange, long ubRange, int capacity);
    SimpleStatement findBoundedRingById(UUID ringId, int centreId);
    SimpleStatement findBoundedRingByIdAndRange(int centreId, long ubRange);
