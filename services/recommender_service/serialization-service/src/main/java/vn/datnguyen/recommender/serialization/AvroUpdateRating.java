...
public class AvroUpdateRating extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8263194430691455685L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroUpdateRating\",\"namespace\":\"vn.datnguyen.recommender.Serialization\",\"fields\":[{\"name\":\"clientId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"itemId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"score\",\"type\":\"int\"}]}");
   ...
   */
  public static vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder newBuilder() {
    return new vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder();
  }
   ...
   * @return A new AvroUpdateRating RecordBuilder
   */
  public static vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder newBuilder(vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder other) {
    return new vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder(other);
  }
   ...
   * @return A new AvroUpdateRating RecordBuilder
   */
  public static vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder newBuilder(vn.datnguyen.recommender.Serialization.AvroUpdateRating other) {
    return new vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroUpdateRating>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(vn.datnguyen.recommender.Serialization.AvroUpdateRating other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder setItemId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder clearItemId() {
      itemId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder setScore(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.Serialization.AvroUpdateRating.Builder clearScore() {
