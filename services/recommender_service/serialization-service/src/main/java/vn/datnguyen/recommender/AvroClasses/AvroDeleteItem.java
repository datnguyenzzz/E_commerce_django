...
public class AvroDeleteItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder newBuilder() {
    return new vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder();
  }

  /**
   * Creates a new AvroDeleteItem RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvroDeleteItem RecordBuilder
   */
  public static vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder newBuilder(vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder other) {
    return new vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder(other);
  }

  /**
   * Creates a new AvroDeleteItem RecordBuilder by copying an existing AvroDeleteItem instance.
   * @param other The existing instance to copy.
   * @return A new AvroDeleteItem RecordBuilder
   */
  public static vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder newBuilder(vn.datnguyen.recommender.AvroClasses.AvroDeleteItem other) {
    return new vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder(other);
  }

  /**
   * RecordBuilder for AvroDeleteItem instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroDeleteItem>
    implements org.apache.avro.data.RecordBuilder<AvroDeleteItem> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvroDeleteItem instance
     * @param other The existing instance to copy.
     */
    private Builder(vn.datnguyen.recommender.AvroClasses.AvroDeleteItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder setItemId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public vn.datnguyen.recommender.AvroClasses.AvroDeleteItem.Builder clearItemId() {
      itemId = null;
