...
public class Words extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4906902580542154760L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Words\",\"namespace\":\"com.example.GatheringService\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"context\",\"type\":\"string\"}]}");
   ...
   */
  public static BinaryMessageEncoder<Words> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a Words instance decoded from the given buffer
   ...
   */
  public Words(java.lang.Integer id, java.lang.CharSequence context) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: context = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.example.GatheringService.Words.Builder newBuilder() {
    return new com.example.GatheringService.Words.Builder();
  }
   ...
   * @return A new Words RecordBuilder
   */
  public static com.example.GatheringService.Words.Builder newBuilder(com.example.GatheringService.Words.Builder other) {
    if (other == null) {
      return new com.example.GatheringService.Words.Builder();
    } else {
      return new com.example.GatheringService.Words.Builder(other);
    }
  }
   ...
   * @return A new Words RecordBuilder
   */
  public static com.example.GatheringService.Words.Builder newBuilder(com.example.GatheringService.Words other) {
    if (other == null) {
      return new com.example.GatheringService.Words.Builder();
    } else {
      return new com.example.GatheringService.Words.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Words>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.GatheringService.Words.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.GatheringService.Words other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.GatheringService.Words.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.GatheringService.Words.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.GatheringService.Words.Builder setContext(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.GatheringService.Words.Builder clearContext() {
      context = null;
    ...
    public Words build() {
      try {
        ...
        record.context = fieldSetFlags()[1] ? this.context : (java.lang.CharSequence) defaultValue(fields()[1]);
        return record;
